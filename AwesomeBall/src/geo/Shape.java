...
public class Shape extends Rectangle2D.Double {
	...
	public double getDx() {
         ...
         * @param dx , la vitesse horizontale de la forme
         */
	...
	public double getDy() {
         ...
         * @param dy , la vitesse verticale de la forme
         */
	...
	public Line2D getSide(int i) {
         ...
         * @param s le rectangle en question
	...
	public boolean nearY(Rectangle2D s) {
        ...
        /**
         * Est-ce que la forme est proche verticallement et horizontallement
         * d'un rectangle s ?
         * @param s le rectangle en question
         * @return Oui/Non à la question
         */
	...
	public boolean near(Rectangle2D s, int line) {
        ...
        /**
         * Est-ce que la forme est bien à l'intérieur d'un rectangle et donc
         * ne touche pas un des côtés de ce rectangle ?
         * @param r le rectangle en question
         * @return Oui/Non à la question
         */
	public boolean insideRect(Rectangle2D r) {
         ...
         * intérieur ? ( Donc on considère que la forme est à l'intérieur 
         * du rectangle )
         * @param r le rectangle en question
         * @return Oui/Non à la question
         */
	public boolean touchRectInLeft(Rectangle2D r) {
        ...
        /**
         * Est-ce que la forme touche le côté haut d'un rectangle par son
	...
	public boolean touchRectInTop(Rectangle2D r) {
        ...
        /**
         * Est-ce que la forme touche le côté droit d'un rectangle par son
         * intérieur ? (Donc on considère que la forme est à l'intérieur du
         * rectangle )
         * @param r le rectangle en question
         * @return Oui/Non à la question
	...
	public boolean touchRectInRight(Rectangle2D r) {
       ...
       /**
         * Est-ce que la forme touche le côté bas d'un rectangle par son
         * intérieur ? (Donc on considère que la forme est à l'intérieur du
         * rectangle )
         * @param r le rectangle en question
         * @return Oui/Non à la question
	...
	public boolean touchRectInBottom(Rectangle2D r) {
         ...
         * @param x position x de la forme
         * @param y position y de la forme
         */
	 ...
	 */
         ...
         * @param x position du côté de la forme
         * @param y position x du côté de la forme
         * @param width largeur du côté de la forme
         * @param height hauteur du côté de la forme
         */
	public void setSize(double x, double y, double width, double height) {
        ...
        /**
         * Bouge la forme dans un rectangle en vérifiant qu'il ne touche pas
         * un des côtés du rectangle ( si oui, il est déplacé par sa vitesse
         * horizontal et/ou vertical en fonction du/des côté(s) touché(s) )
         * @param r le rectangle en question
         */
	public void moveIn(Rectangle2D r) {
        ...
        /**
         * Modifie tout les côtés de la forme : sa position et, si besoin,
         * sa forme
         */
